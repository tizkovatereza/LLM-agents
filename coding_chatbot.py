...
# DEBUGGING 2023_10_02

# 1) Wrong data type error
# openai.error.InvalidRequestError:
# {'role': 'assistant', 'content': None, 'function_call': {'name': 'run_python_code', 'arguments': '{\n  "code": "def sum_two_numbers(num1, num2):\\n    return num1 + num2\\n\\n# Example usage:\\nsum_two_numbers(5, 7)"\n}'}}
# is not of type 'string' - 'messages.5.content'
